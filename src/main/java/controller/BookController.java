...
public class BookController implements IBookController {
    ...
    /**
     * supports book register in checking out books.
     * Process book check-out (borrowing the book).
     *
     * @param books    loaded from csv file.
     * @param ISBN     the ISBN of the book to check out.
     * @param bookList list of filtered books
     */
     ...
     * @param bookList to check back into file.
     */
